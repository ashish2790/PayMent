DROP PROCEDURE TCH_HANDSHAKE_PROC; 
...
BEGIN
  ...
  OPEN C_HANDSHAKE_DETAILS FOR
    SELECT THM.TID , TTP.TPDU , THM.MID , TTP.NII , THM.LINEENC , TMP.BANKNAME , TMP.DBANAME, TMP.LOCATION , 
    TMP.LEGALNAME,  THM.REFUNDNEW , TTP.RELOAD , THM.CASHBACK,TTP.BAL_INQ_ALWD , THM.CASHBACKPUR,THM.ADJUSTMENT ,THM.AUTOSETTLEMENT,TTP.PREAUTH,TTP.OUTLETCODE,TTP.OUTLETNAME,TTP.BILLERNAME
