create or replace PROCEDURE TCH_REFUND_ACK_PROC (
...
BEGIN
   O_DEBUG_POINT_ACK:=1;
    ...
    AND TPT.P_TERMINAL_SERIAL_NUMBER = I_TERMINAL_SERIAL_NUMBER AND TPT.P_REQUEST_TYPE = 'REFUND';
