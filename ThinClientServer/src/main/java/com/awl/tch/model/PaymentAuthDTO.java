...
/**
 * Entity for preauth transaction
 * @author ashish.bhavsar
 *
 */
@Table(name="TCH_PAYMENT_AUTH_TXN")
public class PaymentAuthDTO {
	...
	public String toString() {
		return "PaymentAuthDTO [paymentId=" + paymentId + ", panNumber=" + panNumber + ", originalAmount="
				+ originalAmount + ", cardEntryMode=" + cardEntryMode + ", exchangeRate=" + exchangeRate
				+ ", currencyCode=" + currencyCode + ", currencyName=" + currencyName + ", markup=" + markup
				+ ", merchantId=" + merchantId + ", terminalId=" + terminalId + ", customerName=" + customerName
				+ ", clientId=" + clientId + ", invoiceNumber=" + invoiceNumber + ", track2=" + track2 + ", stanNumber="
				+ stanNumber + ", binNumber=" + binNumber + ", expiryDate=" + expiryDate + ", field55=" + field55
				...
				+ ", igsttax=" + igsttax + ", tchPaymentAgt=" + tchPaymentAgt + ", tchAgtSubMer=" + tchAgtSubMer
				+ ", tempBatchNumber=" + tempBatchNumber + ", tableId=" + tableId + "]";
	}
