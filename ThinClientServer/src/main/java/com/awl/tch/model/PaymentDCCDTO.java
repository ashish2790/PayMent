 ...
 *
 */
@Table(name="TCH_PAYMENT_DCC_TXN")
public class PaymentDCCDTO{
	...
	private Integer lastFourDigitValue;
	 ...
	 */
	public Integer getLastFourDigitValue() {
	 ...
	 */
	public void setLastFourDigitValue(Integer lastFourDigitValue) {
