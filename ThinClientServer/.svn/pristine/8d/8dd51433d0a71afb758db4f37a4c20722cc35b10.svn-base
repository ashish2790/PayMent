...
/**
 * Entity for payment transaction like SALE, REFUND, VOID
 * @author ashish.bhavsar
 *
 */
@Table(name="TCH_PAYMENT_TXN")
public class PaymentDTO{

	@Id
	@Column(name="P_ID")
	@Sequence(name = Constants.TCH_PAYMENT_ID_SEQ)
	...
	@Column(name= "P_MERCHANT_VPA")
	private String merchantVPA;
	
	@Column(name= "P_CUST_VPA")
	private String customerVPA;
	
	@Column(name= "TCH_PAYMENT_AGT")
	private String tchPaymentAgt;
	
	@Column(name= "TCH_AGT_SUB_MER")
	private String tchAgtSubMer;
	...
	/**
	 * @return the tchPaymentAgt
	 */
	public String getTchPaymentAgt() {
		return tchPaymentAgt;
	}

	/**
	 * @param tchPaymentAgt the tchPaymentAgt to set
	 */
	public void setTchPaymentAgt(String tchPaymentAgt) {
		this.tchPaymentAgt = tchPaymentAgt;
	}

	/**
	 * @return the tchAgtSubMer
	 */
	public String getTchAgtSubMer() {
		return tchAgtSubMer;
	}

	/**
	 * @param tchAgtSubMer the tchAgtSubMer to set
	 */
	public void setTchAgtSubMer(String tchAgtSubMer) {
		this.tchAgtSubMer = tchAgtSubMer;
	}
	...
	public String toString() {
		return "PaymentDTO [paymentId=" + paymentId + ", panNumber=" + panNumber + ", originalAmount=" + originalAmount
				+ ", cardEntryMode=" + cardEntryMode + ", exchangeRate=" + exchangeRate + ", currencyCode="
				+ currencyCode + ", currencyName=" + currencyName + ", markup=" + markup + ", merchantId=" + merchantId
				+ ", terminalId=" + terminalId + ", customerName=" + customerName + ", clientId=" + clientId
				+ ", invoiceNumber=" + invoiceNumber + ", track2=" + track2 + ", stanNumber=" + stanNumber
				+ ", binNumber=" + binNumber + ", expiryDate=" + expiryDate + ", field55=" + field55
				+ ", additionalAmount=" + additionalAmount + ", accountType=" + accountType + ", terminalSerialNumber="
				+ terminalSerialNumber + ", cardLabel=" + cardLabel + ", date=" + date + ", time=" + time
				+ ", sessionKey=" + sessionKey + ", decisionFlag=" + decisionFlag + ", referenceValue=" + referenceValue
				+ ", batchNumber=" + batchNumber + ", pinBlock=" + pinBlock + ", dccAmount=" + dccAmount
				+ ", requestType=" + requestType + ", responseCode=" + responseCode + ", status=" + status
				+ ", retrivalRefNumber=" + retrivalRefNumber + ", authorizationId=" + authorizationId
				+ ", schemaTransactionId=" + schemaTransactionId + ", voidApprovedFlag=" + voidApprovedFlag
				+ ", created=" + created + ", updated=" + updated + ", settlementFlag=" + settlementFlag
				+ ", refundFlag=" + refundFlag + ", lastFourDigitValue=" + lastFourDigitValue + ", issuerField55="
				+ issuerField55 + ", voidStatus=" + voidStatus + ", refundStatus=" + refundStatus + ", extraValue="
				+ extraValue + ", tipPercent=" + tipPercent + ", cashback=" + cashback + ", cashbackPur=" + cashbackPur
				+ ", tipApproved=" + tipApproved + ", refundApproved=" + refundApproved + ", tpdu=" + tpdu + ", nii="
				+ nii + ", saleCompletionFlag=" + saleCompletionFlag + ", processingCode=" + processingCode + ", MTI="
				+ MTI + ", field63=" + field63 + ", branchCode=" + branchCode + ", appName=" + appName
				+ ", transactionChannel=" + transactionChannel + ", extraInfo=" + extraInfo + ", bankCode=" + bankCode
				+ ", emiIndicator=" + emiIndicator + ", cardTypeInd=" + cardTypeInd + ", internationalFlag="
				+ internationalFlag + ", feeFlag=" + feeFlag + ", feeValue=" + feeValue + ", cgsttax=" + cgsttax
				+ ", igsttax=" + igsttax + ", merchantVPA=" + merchantVPA + ", customerVPA=" + customerVPA
				+ ", tchPaymentAgt=" + tchPaymentAgt + ", tchAgtSubMer=" + tchAgtSubMer + ", tempBatchNumber="
				+ tempBatchNumber + ", tableId=" + tableId + "]";
	}
}
