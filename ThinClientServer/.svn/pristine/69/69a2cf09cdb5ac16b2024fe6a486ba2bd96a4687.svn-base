...
public class WalletDTO {
	...
	public WalletDTO getWalletDTO(FcWalletRequest request,String walletType){
		...
		this.setTxnDateNTime(UtilityHelper.getWalletDateTime(request.getTxnDatenTime()));
		...
		if(request.getTxnAmount() != null){
			this.setTxnAmount(request.getTxnAmount()); //changes done as per requirement chnage in production
